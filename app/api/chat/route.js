...
Перед написанием скрипта ВСЕГДА спроси: "Какой длины должен быть скрипт? (укажи в символах, например: 500, 1000, 1500)"
Пиши скрипт строго указанной длины. Без SSML тегов и пауз.
